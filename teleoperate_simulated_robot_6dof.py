...
leader_dynamixel = Dynamixel.Config(baudrate=1_000_000, device_name='/dev/tty.usbmodem575E0031731').instantiate()
leader = Robot(leader_dynamixel, servo_ids=[1, 2, 3, 4, 5, 6])

m = mujoco.MjModel.from_xml_path('simulation/low_cost_robot_6dof/scene.xml')
d = mujoco.MjData(m)
